...
import { CalendarDays, ClipboardList, BookOpenText, Layers3, LayoutDashboard, Menu, X } from 'lucide-react'; 
import Jam from './Jam';
import { useState, useEffect } from 'react';

const navItems = [
  { name: 'Dashboard', href: '/', icon: LayoutDashboard },
  { name: 'Jadwal Kuliah', href: '/jadwal', icon: CalendarDays },
  { name: 'Daftar Tugas', href: '/tugas', icon: ClipboardList },
  { name: 'List Materi', href: '/materi', icon: BookOpenText },
  { name: 'List Matkul', href: '/matkul', icon: Layers3 },
];
