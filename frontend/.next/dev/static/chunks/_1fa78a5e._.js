...
function Jadwal() {
    ...
    const handleAdd = async (e)=>{
        ...
        setSubmitting(true);
        try {
            const added = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addJadwal"])(newJadwal);
            setJadwalData([
                ...jadwalData,
                added
            ]);
